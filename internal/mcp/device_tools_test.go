...
func TestHandleStopDeviceSession_AllHydratesFromBackend(t *testing.T) {
	...
	apiServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case r.URL.Path == "/api/v1/execution/device/status/cancel/55555555-5555-5555-5555-555555555555":
			cancelCalls.Add(1)
			_, _ = w.Write([]byte(`{"success":true,"request_accepted":true,"session_settled":true,"device_released":true,"message":"cancelled","workflow_run_id":"55555555-5555-5555-5555-555555555555"}`))
		default:
			http.NotFound(w, r)
		}
	}))
