...
type HITLApprovalRequest struct {
	...
	TestExecutionTaskId string `json:"test_execution_task_id"`
...
// UpdateWorkflowScheduleApiV1WorkflowsUpdateScheduleWorkflowIdPutJSONRequestBody defines body for UpdateWorkflowScheduleApiV1WorkflowsUpdateScheduleWorkflowIdPut for application/json ContentType.
type UpdateWorkflowScheduleApiV1WorkflowsUpdateScheduleWorkflowIdPutJSONRequestBody = UpdateWorkflowScheduleRequest
