...
type AdminTestExecution struct {
	...
	// Source Execution source: ui, api, ci_cd, or workflow (was user_id)
	Source    *string    `json:"source"`
...
type OrgTestMonitorItem struct {
	...
	// Source Execution source: ui, api, ci_cd, or workflow
...
type TaskID struct {
	...
	// Source Execution source: ui, api, ci_cd, or workflow. Defaults to 'api' for direct API calls.
	Source         *string `json:"source"`
...
type WorkflowExecutionsBaseSchema struct {
	...
	// Source Execution source: ui, api, ci_cd
	Source    *string    `json:"source,omitempty"`
	StartedAt *time.Time `json:"started_at"`
	Status    string     `json:"status"`
	Success   *bool      `json:"success"`
...
// GetActiveDeviceSessionCountApiV1ExecutionDeviceSessionsActiveCountGetParams defines parameters for GetActiveDeviceSessionCountApiV1ExecutionDeviceSessionsActiveCountGet.
type GetActiveDeviceSessionCountApiV1ExecutionDeviceSessionsActiveCountGetParams struct {
	OrgId string `form:"org_id" json:"org_id"`
}
