<!-- mintlify
title: "Guide: Your First Test"
description: "Install the CLI, upload a build, create and run your first test, then set up YAML-as-source-of-truth for your team"
target: get-started/first-test-guide.mdx
-->
...
Edit YAML in a feature branch, review the diff in a pull request like any code change.
...
- [Dev Loop](/cli/dev-loop-guide) — fast local verification with hot reload
- [YAML Schema](/yaml/yaml-schema) — full test file reference
- [Advanced Tests](/yaml/advanced-tests-guide) — scripts, modules, variables, control flow
- [CI/CD Pipeline](/ci-cd/pipeline-guide) — run tests in GitHub Actions
